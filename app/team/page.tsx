        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl rounded-lg border bg-card p-8 text-center shadow-sm">
            ...
            <p className="mb-8 text-lg text-muted-foreground">
              We're always looking for talented individuals who are passionate about software development.
              Check out our open positions and join us in shaping the future of AI.
            </p>
            <a href="/contact" className="rounded-md bg-primary px-8 py-3 text-lg font-medium text-primary-foreground shadow-sm hover:bg-primary/90">
              Contact Us
            </a>
          </div>
        </div>
